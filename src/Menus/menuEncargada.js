...
function MenuEncargada() {
  ...
  return ( <
    ...
    Bienvenida <
    /button> <
    button id = "administrarSolicitudes"
    className = "button"
    onClick = {
      () => {
        setIndexVisible( 2 );
    ...
    /button> <
    button id = "administrarSolicitud"
    className = "button"
    onClick = {
      () => {
        setIndexVisible( 3 );
    ...
    /button> <
    button id = "administracionGeneral"
    className = "button"
    onClick = {
      () => {
        setIndexVisible( 5 );
    ...
    /button> <
    button id = "administracionUsuarios"
    className = "button"
    onClick = {
      () => {
        setIndexVisible( 15 );
    ...
    /button> <
    button id = "administracionTramites"
    className = "button"
    onClick = {
      () => {
        setIndexVisible( 16 );
    ...
    <
    CambiarVistaController VistaIndex = {
      indexVisible
    }
    currentUser = {
      currentUser
    ...
    CargarMatricula = {
      cargarMatriculaSolicitud
    }
    MatriculaCargada = {
      matriculaSolicitudCargar
    }
    /> <
    RegresarMenu / >
    <
