...
const FooterContainer = styled.div`
  margin-top: clamp(800px, 1000px, 2000px);
  padding: 3em;
  padding-top: 2em;
    ...
    <FooterContainer>
      ...
      <div className="row">
        <div className="col-sm-6">
          ...
          <ul>
            <FooterList>
              <FooterLink href="" type="application/pdf" target="_blank">
                Política de Privacidad
              </FooterLink>
            </FooterList>
            <FooterList>
              <FooterLink href="http://ith.mx/">Página inicial ITH</FooterLink>
            </FooterList>
            <FooterList>
              <FooterLink href="http://www.sith.ith.mx/menu/">SITH</FooterLink>
            </FooterList>
          </ul>
        </div>
        <div className="col-sm-6">
